...
make_logging_data <- function(dat, use_markers, type_fun) {
  ...
  if (use_markers &&
      ...
      # html format is not supported anymore since RStudio version 2023.03.0
      # see: 
      # https://github.com/rstudio/rstudio/issues/10062#issuecomment-1044883002
      # Fixed rendering of custom source markers (#12425):
      # https://docs.posit.co/ide/news/#rstudio-ide-10
      rstudioapi::versionInfo()$version < "2023.03.0") {
